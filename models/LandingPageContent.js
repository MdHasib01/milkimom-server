...
export const DEFAULT_CONTENTS = {
  milkimom: {
    ...
    carouselItems: [
      ...
      },
      {
        id: '2',
        title: 'মা ও শিশুর যত্নে একটুও ছাড় নয়!',
        description: '১০০% প্রাকৃতিক উপাদান   smoothflow: {
    ...
    heroBadge: '১০০% সাইডইফেক মুক্ত ও সেফ ফর্মুলা',
    ...
    carouselItems: [
      ...
      },
      {
        id: '2',
        title: 'মা ও শিশুর যত্নে একটুও ছাড় নয়!',
        description: '১০০% প্রাকৃতিক উপাদান সমৃদ্ধ যা মায়ের বুকের দুধ বাড়াতে ও ক্লগড ডাক্ট দূর করতে সাহায্য করে।',
    ...
    doctorItems: [
      {
        ...
        description: 'স্মুথফ্লো তৈরি হয়েছে গভর্নমেন্ট রেজিস্টার্ড চিকিৎসকদের তত্ত্বাবধানে, প্রাচীন আয়ুর্বেদিক জ্ঞান ও আধুনিক বিজ্ঞানের গবেষণার সমন্বয়ে। প্রতিটি ব্যাচ ল্যাব টেস্টেড ও BSTI সার্টিফাইড।',
  ...
  },�মুথফ্লো প্রিমিয়াম ন্যাচারাল ফর্মুলা',
